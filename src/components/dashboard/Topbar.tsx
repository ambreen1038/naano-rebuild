import { Bell, ChevronDown, CreditCard, Sun } from "lucide-react";
    ...
    <header className="flex h-16 shrink-0 items-center gap-3 border-b border-zinc-200 bg-white px-6 dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <details className="relative">
          <summary className="relative flex h-9 w-9 cursor-pointer list-none items-center justify-center rounded-full bg-zinc-900 text-sm font-semibold text-white [&::-webkit-details-marker]:hidden dark:bg-zinc-50 dark:text-zinc-900">
            {initial}
