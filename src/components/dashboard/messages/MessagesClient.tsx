    ...
    <div className="flex h-full">
      <div className="flex w-80 shrink-0 flex-col border-r border-zinc-200 dark:border-zinc-800">
        ...
        <div className="mt-3 flex items-center gap-2 px-5">
          <span className="rounded-full border border-zinc-200 bg-white px-3.5 py-1.5 text-sm font-medium text-blue-600 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
            All messages
          </span>
          <span className="flex items-center gap-1 rounded-full px-3.5 py-1.5 text-sm font-medium text-zinc-500">
            Campaign
        ...
        <div className="mt-3 flex-1 overflow-y-auto">
          <button
            type="button"
            className="flex w-full items-start gap-3 bg-zinc-50 px-5 py-4 text-left dark:bg-zinc-900"
          >
            <Image
          ...
          <p className="px-5 py-4 text-sm text-zinc-400">No conversation yet.</p>
        </div>
      </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-sky-100 to-sky-50 p-6 dark:from-sky-950 dark:to-zinc-950">
            ...
            <p className="mt-1 max-w-sm text-sm text-zinc-600 dark:text-zinc-400">
              Product question, bug or performance concern: everything stays
              here and the team steps in when needed.
            </p>
              ...
              m.role === "bot" ? (
                <div key={i} className="flex flex-col items-start gap-1">
                  ...
                  <span className="ml-1 flex items-center gap-1.5 text-xs text-zinc-400">
                    <Image src="/naano-logomark.png" alt="" width={14} height={11} />
                    Naano
                  </span>
                </div>
              ) : (
